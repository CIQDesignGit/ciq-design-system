...
|-------|-------|
| **Name** | `Sheet` |
| **neo-canvas source** | `src/components/atoms/sheet.tsx` |
| **Related files** | — |
| **Story** | `src/components/atoms/sheet.stories.tsx` |
| **Storybook title** | `Atoms/Sheet` |
...
Export Sheet* compound parts as in source.
...
| Package | Why |
|---------|-----|
| `@radix-ui/react-dialog` | Sheet uses Dialog |
...
CVA side variants; portal optional container; strip queryElement.

## Source of truth

1. Port `src/components/atoms/sheet.tsx` (and related files).
...
- [ ] Stories render under `Atoms/Sheet`
