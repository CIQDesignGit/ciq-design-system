...
|-------|-------|
| **Name** | `Table` |
| **neo-canvas source** | `src/components/atoms/table.tsx` |
| **Related files** | — |
| **Story** | `src/components/atoms/table.stories.tsx` |
| **Storybook title** | `Atoms/Table` |
...
Table/TableHeader/TableBody/TableRow/TableCell primitives only — not BaseDataTable.

## Source of truth

1. Port `src/components/atoms/table.tsx` (and related files).
...
- [ ] Stories render under `Atoms/Table`
