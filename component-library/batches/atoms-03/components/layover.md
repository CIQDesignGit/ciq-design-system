...
|-------|-------|
| **Name** | `Layover` |
| **neo-canvas source** | `src/components/atoms/layover.tsx` |
| **Related files** | — |
| **Story** | `src/components/atoms/layover.stories.tsx` |
| **Storybook title** | `Atoms/Layover` |
...
Custom overlay positions: center/right/left/bottom/top.

## Source of truth

1. Port `src/components/atoms/layover.tsx` (and related files).
...
- [ ] Stories render under `Atoms/Layover`
