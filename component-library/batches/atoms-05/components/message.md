...
|-------|-------|
| **Name** | `Message` |
| **neo-canvas source** | `src/components/atoms/message.tsx` |
| **Related files** | — |
| **Story** | `src/components/atoms/message.stories.tsx` |
| **Storybook title** | `Atoms/Message` |
...
Chat message compound parts — preserve export names from source.

## Source of truth

1. Port `src/components/atoms/message.tsx` (and related files).
...
- [ ] Stories render under `Atoms/Message`
