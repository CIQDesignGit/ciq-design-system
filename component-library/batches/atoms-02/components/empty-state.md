...
|-------|-------|
| **Name** | `EmptyState` |
| **neo-canvas source** | `src/components/atoms/empty-state.tsx` |
| **Related files** | — |
| **Story** | `src/components/atoms/empty-state.stories.tsx` |
| **Storybook title** | `Atoms/EmptyState` |
...
Centered empty placeholder (title/description/children).

## Source of truth

1. Port `src/components/atoms/empty-state.tsx` (and related files).
...
- [ ] Stories render under `Atoms/EmptyState`
