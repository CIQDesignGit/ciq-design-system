...
|-------|-------|
| **Name** | `RadioGroup` |
| **neo-canvas source** | `src/components/atoms/radio-group.tsx` |
| **Related files** | — |
| **Story** | `src/components/atoms/RadioGroup.stories.tsx` |
| **Storybook title** | `Atoms/RadioGroup` |
...
| Package | Why |
|---------|-----|
| `@radix-ui/react-radio-group` | Primitive |
...
Export RadioGroup + RadioGroupItem as in source.

## Source of truth

1. Port `src/components/atoms/radio-group.tsx` (and related files).
...
- [ ] Stories render under `Atoms/RadioGroup`
