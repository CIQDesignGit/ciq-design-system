...
|-------|-------|
| **Name** | `HoverCard` |
| **neo-canvas source** | `src/components/atoms/hover-card.tsx` |
| **Related files** | — |
| **Story** | `src/components/atoms/hover-card.stories.tsx` |
| **Storybook title** | `Atoms/HoverCard` |
...
| Package | Why |
|---------|-----|
| `@radix-ui/react-hover-card` | Primitive |
...
1. Port `src/components/atoms/hover-card.tsx` (and related files).
...
- [ ] Stories render under `Atoms/HoverCard`
