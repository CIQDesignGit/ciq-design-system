...
|-------|-------|
| **Name** | `Tabs` |
| **neo-canvas source** | `src/components/atoms/tabs.tsx` |
| **Related files** | — |
| **Story** | `src/components/atoms/tabs.stories.tsx` |
| **Storybook title** | `Atoms/Tabs` |
...
1. Port `src/components/atoms/tabs.tsx` (and related files).
...
- [ ] Stories render under `Atoms/Tabs`
