...
export type ResponseStreamProps = {
  ...
  readonly mode?: Mode;
  readonly speed?: number; // 1-100, where 1 is slowest and 100 is fastest
  readonly className?: string;
  readonly onComplete?: () => void;
  readonly as?: keyof React.JSX.IntrinsicElements; // Element type to render
  readonly fadeDuration?: number; // Custom fade duration in ms (overrides speed)
  readonly segmentDelay?: number; // Custom delay between segments in ms (overrides speed)
  readonly characterChunkSize?: number; // Custom characters per frame for typewriter mode (overrides speed)
};
