...
export function TextDotsLoader({
  ...
  return (
    <div className={cn("inline-flex items-center", className)}>
      <span className={cn("text-tertiary-text font-medium", textSizes[size])}>{text}</span>
      <span className="inline-flex">
        <span className="text-tertiary-text animate-[loading-dots_1.4s_infinite_0.2s]">.</span>
        <span className="text-tertiary-text animate-[loading-dots_1.4s_infinite_0.4s]">.</span>
        <span className="text-tertiary-text animate-[loading-dots_1.4s_infinite_0.6s]">.</span>
      </span>
    </div>
  );
}
